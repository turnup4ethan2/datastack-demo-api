...
| Field | Type   | Required | Description                        |
|-------|--------|----------|------------------------------------|
| `tag` | string | No       | Query param. Filter by single tag. |
...
| `gift_message`     | string \| null| No       | Message included with the shipment. Defaults `null`. |
