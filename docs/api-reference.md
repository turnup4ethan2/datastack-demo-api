...
**Response** — `201 Created`, a user object with the fields listed under `GET /users`.
...
**Response** — `200 OK`, a user object with the fields listed under `GET /users`.
...
| `tags` | array of string | No | Tags applied to the product. Defaults to `[]` |
...
**Response** — `201 Created`, a product object with the fields listed under `GET /products`.
...
**Response** — `200 OK`, a product object with the fields listed under `GET /products`.
...
**Response** — `200 OK`, an order object with the fields listed under `POST /orders`.
