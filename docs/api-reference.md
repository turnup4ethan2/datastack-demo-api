...
> **Last updated: July 2026** — This document is kept in sync automatically by Devin.
...
| `items` | `OrderItem[]` | Yes | List of items to order |
...
| `items[].unit_price_cents` | `integer` | Price per unit in USD cents |
