...
> **Last updated: April 2026** — This document is auto-synced from the route definitions in `app/routes/` by Devin.
...
| `tags`            | `string[]` | No       | Tags to associate with product (default `[]`) |
