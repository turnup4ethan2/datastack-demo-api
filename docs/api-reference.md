...
|-------------------|--------|----------|--------------------------------------|
| `organization_id` | string | Yes      | The organization to list users from  |
...
| `items`             | list[object] | Yes      | List of order items (see below)                  |
...
| `items`            | list[object] | Order items with `product_id`, `quantity`, `unit_price_cents` |
