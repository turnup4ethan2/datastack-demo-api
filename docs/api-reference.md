...
| `tags`            | array of string | No       | Tags for the product. Default `[]`.  |
...
| `promo_code`        | string            | No       | Promotional code to apply. Default `null`.       |
...
Returns the updated order (same schema as [Get Order](#get-order)).
