...
**Response** — `201 Created`, a User object.
...
**Response** — `201 Created`, a Product object.
...
**Response** — `200 OK`, a Product object.
...
| `gift_message`      | `string`      | No       | Gift message to include with the shipment. Default `null`.   |
