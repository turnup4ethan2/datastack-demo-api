...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `email` | string (email) | Yes | Email address; validated format |
...
| `promo_code` | string \| null | No | Promotion code. Defaults to `null` |
...
| `promo_code` | string \| null | Promotion code applied |
...
Service liveness check; requires no authentication.
