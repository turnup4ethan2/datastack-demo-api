...
| Parameter | Type   | Required | Description                 |
|-----------|--------|----------|-----------------------------|
| `tag`     | string | No       | Filter products by tag name |
...
| `tags`             | list[string] | List of tag strings                  |
| `created_at`       | string       | ISO 8601 timestamp                   |
...
| `tags`             | list[string] | No       | List of tag strings (default: `[]`)  |
...
| `tracking_number`  | string\|null | Tracking number, if assigned             |
| `created_at`       | string       | ISO 8601 timestamp                       |
