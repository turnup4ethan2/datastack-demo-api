...
> **Last updated: May 2026** — This document is auto-synced from `app/routes/` by Devin.
...
> The previous `api_key` query parameter has been removed. Requests missing or supplying an invalid Bearer token return `401`.
...
| Field | Type   | Required | Description                            |
|-------|--------|----------|----------------------------------------|
| `tag` | string | No       | Filter products that include this tag. |
...
| `inventory_count`  | integer         | Units currently available.                      |
...
| `priority_shipping`  | boolean          | No       | Use expedited shipping. Defaults to `false`.                 |
...
|---------------------|------------------|----------------------------------------------------------------------------|
| `id`                | string           | Order ID.                                                                  |
| `user_id`           | string           | ID of the user that placed the order.                                      |
