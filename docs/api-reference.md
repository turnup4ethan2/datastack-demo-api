...
The previous `api_key` query-parameter scheme is deprecated and no longer supported.
...
All fields returned per product:
...
| tags            | array<string> | No       | Tags for the product; defaults to `[]` |
