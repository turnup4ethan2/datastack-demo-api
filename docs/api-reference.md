...
> **Last updated: June 2026** — This document is kept in sync automatically by Devin.
...
|-----------|------|----------|-------------|
| `organization_id` | string | Yes | Filter users by organization |
...
| `gift_message` | string | No | Optional gift message included with shipment |
