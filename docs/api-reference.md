...
> **Last updated: June 2026** — This document is automatically maintained by Devin.
...
| `tags` | array of strings | No | Categorization tags. Defaults to `[]` |
...
| `tracking_number` | string or null | Shipment tracking number (populated after shipping) |
| `created_at` | string | ISO 8601 timestamp |
...
| `tracking_number` | string | No | Shipment tracking number (typically set when status becomes `"shipped"`) |
