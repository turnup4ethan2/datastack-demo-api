...
| `tags` | `array[string]` | List of product tags |
| `created_at` | `string` | ISO 8601 timestamp of product creation |
...
| `tags` | `array[string]` | No | List of product tags. Defaults to `[]` |
...
| `items` | `array[OrderItem]` | Yes | List of items in the order |
