...
|-------|------|----------|-------------|
| `organization_id` | string | Yes | Query parameter. Organization whose users are returned. |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `user_id` | string | Yes | Path parameter. ID of the user to fetch. |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `user_id` | string | Yes | Path parameter. ID of the user to delete. |
...
| `tags` | array of string | No | Tags to assign. Defaults to `[]`. |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `product_id` | string | Yes | Path parameter. ID of the product to fetch. |
...
An order item has the fields `product_id` (string), `quantity` (integer), and `unit_price_cents` (integer, USD cents).
...
| `items` | array of order item | Yes | Line items. `total_cents` is computed as the sum of `quantity * unit_price_cents`. |
...
| `gift_message` | string | No | Message included with the shipment. Defaults to `null`. Accepted on input but not returned in the order object. |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `order_id` | string | Yes | Path parameter. ID of the order to fetch. |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `order_id` | string | Yes | Path parameter. ID of the order to update. |
| `status` | string | Yes | Body field. One of `pending`, `confirmed`, `shipped`, `delivered`, `cancelled`. |
| `tracking_number` | string | No | Body field. Carrier tracking number. Defaults to `null`. |
