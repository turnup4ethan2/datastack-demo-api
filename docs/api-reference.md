...
> **Last updated: March 2026** — This document is auto-maintained. See the latest commit history for change details.
...
| `inventory_count` | `integer` | No | Number of units in stock (default: `0`) |
| `tags` | `array[string]` | No | List of tags (default: `[]`) |
...
| `items` | `array[OrderItem]` | Yes | List of order line items (see below) |
...
| `items` | `array[OrderItem]` | List of order line items |
...
| `promo_code` | `string \| null` | Applied promotional code, or `null` |
