...
> **Last updated: April 2026** — This document is automatically kept in sync with the source code by Devin.
...
| `priority_shipping` | `boolean` | No (default: `false`) | Enable priority shipping |
| `gift_message` | `string` | No | Gift message to include |
...
| `tracking_number` | `string` or `null` | Tracking number (initially `null`) |
| `created_at` | `string` | ISO 8601 timestamp |
