...
| Field             | Type   | Required | Description                                                  |
|-------------------|--------|----------|--------------------------------------------------------------|
| `email`           | string | Yes      | User email (must be a valid email address)                   |
...
| `inventory_count` | integer         | Units currently in inventory                  |
...
| `inventory_count` | integer         | No       | Defaults to `0`                   |
| `tags`            | array of string | No       | Defaults to `[]`                  |
...
Same schema as `GET /products` item.
...
| `tracking_number`  | string \| null       | Shipping tracking number, if available                               |
| `created_at`       | string               | ISO 8601 timestamp                                                   |
