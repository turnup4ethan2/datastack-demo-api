...
Query-parameter API keys (`?api_key=`) are not supported.
...
**Response** — `201 Created` — User object (see fields under `GET /users`)
...
**Response** — `200 OK` — User object (see fields under `GET /users`)
...
**Response** — `201 Created` — Product object (see fields under `GET /products`)
...
**Response** — `200 OK` — Product object (see fields under `GET /products`)
