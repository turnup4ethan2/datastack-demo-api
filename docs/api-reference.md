...
| Field | Type   | Required | Description                                  |
|-------|--------|----------|----------------------------------------------|
| `tag` | string | No       | Query parameter. Only return products carrying this tag. |
...
| `tags`            | array[string] | No       | Tags to attach. Defaults to `[]`.        |
...
| `items`             | array[order item]   | Yes      | Line items. See the order item object above.                     |
| `shipping_address`  | string              | Yes      | Destination address.                                             |
| `promo_code`        | string \| null      | No       | Promotion code to apply. Defaults to `null`.                     |
| `priority_shipping` | boolean             | No       | Request expedited shipping. Defaults to `false`. Not echoed back in the response. |
| `gift_message`      | string \| null      | No       | Message to include with the shipment. Defaults to `null`. Not echoed back in the response. |
