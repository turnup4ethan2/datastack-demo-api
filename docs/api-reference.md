...
> **Last updated: May 2026** — This document is generated automatically by Devin and kept in sync with the source code.
...
| `items`             | `list[object]` | Yes      | List of order line items (see below)              |
...
| `items`            | `list[object]` | Line items (same schema as request)               |
