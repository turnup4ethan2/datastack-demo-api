...
> **Last updated: May 2026** — This document is kept in sync automatically via Devin.
...
| `tags` | array of strings | No | Associated tags (default: `[]`) |
...
| `items` | array of objects | Yes | Line items (see below) |
...
| `items` | array of objects | Line items (same schema as request) |
