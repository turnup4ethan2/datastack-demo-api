...
> **Last updated: March 2026** — Auto-generated from source code. Reviewed for accuracy against `app/routes/`.
...
| `items`             | `list[object]` | Yes      | Array of order line items (see below)                    |
...
| `items`            | `list[object]` | Array of order line items                          |
