...
| Field           | Type   | Description                                  |
|-----------------|--------|----------------------------------------------|
| id              | string | Unique user ID (e.g. `usr_abc123`)           |
...
| Field           | Type          | Description                          |
|-----------------|---------------|--------------------------------------|
| id              | string        | Unique product ID (e.g. `prod_001`)  |
| name            | string        | Product name                         |
| description     | string        | Product description                  |
| price_cents     | integer       | Price in US cents                    |
...
| price_cents     | integer       | Yes      | Price in US cents                  |
...
**Response** — `201 Created` — [Product object](#product-object)
...
**Response** — `200 OK` — [Product object](#product-object)
...
| Field            | Type              | Description                                                              |
|------------------|-------------------|--------------------------------------------------------------------------|
| id               | string            | Unique order ID (e.g. `ord_001`)                                         |
...
| total_cents      | integer           | Order total in cents (sum of `quantity * unit_price_cents` over items)   |
...
| items             | array[OrderItem] | Yes      | Line items (see [OrderItem object](#orderitem-object)) |
