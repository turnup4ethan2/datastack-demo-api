...
| `tags`            | `string[]` | Tags applied to the product         |
| `created_at`      | `string`   | ISO 8601 timestamp                  |
...
| `promo_code`        | `string\|null` | No       | Promotion code                                         |
| `priority_shipping` | `boolean`      | No       | Request expedited shipping (default `false`)           |
| `gift_message`      | `string\|null` | No       | Message included with the shipment                     |
...
| `promo_code`       | `string\|null` | Promotion code, if any                                                    |
...
| `tracking_number` | `string\|null` | No       | Carrier tracking number                                            |
