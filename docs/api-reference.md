...
> **Last updated: June 2026** — This document is auto-maintained by Devin.
...
| Field              | Type    | Required | Description                     |
|--------------------|---------|----------|---------------------------------|
| `product_id`       | string  | Yes      | ID of the product to order      |
...
| `total_cents`      | integer      | Computed order total in USD cents                  |
| `promo_code`       | string\|null | Applied promo code, if any                         |
| `tracking_number`  | string\|null | Shipment tracking number, if assigned              |
| `created_at`       | string       | ISO 8601 timestamp of creation                     |
