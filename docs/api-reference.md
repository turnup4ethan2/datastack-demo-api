...
> **Last updated: May 2026** — This document is kept in sync automatically by Devin.
...
| `tags` | `list[string]` | No | Tags for the product. Defaults to `[]` |
...
| `tracking_number` | `string` | No | Shipment tracking number (typically set when transitioning to `"shipped"`) |
